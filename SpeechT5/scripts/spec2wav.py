...
def main():
    ...
    parser.add_argument(
        "-i",
        "--input_dir",
        default="/home/ec2-user/t5/SpeechT5/exp/inference_tts/debug-dev-clean-v1_checkpoint17/dev-clean",
        help="Input directory containing .npy files",
    )
    parser.add_argument(
        "-o",
        "--output_dir",
        default="/home/ec2-user/t5/SpeechT5/exp/inference_tts/debug-dev-clean-v1_checkpoint17/dev-clean_wav",
