...
if [ $stage -le 2 ] && [ $stop_stage -ge 2 ]; then
    ...
    ln -sfv ${PWD}/${tsv_dir}/${tgt_dev_set_name}.lc.wrd ${PWD}/${tts_data_dir}/${tgt_dev_set_name}.txt
    ln -sfv ${PWD}/${tsv_dir}/${tgt_train_set_name}.lc.wrd ${PWD}/${tts_data_dir}/${tgt_train_set_name}.txt
    for split in ${test_sets}; do
